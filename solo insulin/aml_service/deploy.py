...
data1 =[72303084, 7, "Emergency", "ToHome", "EmergencyRoom", 1, 220978068, "Caucasian", "Female", "[70-80)", 63, 0, 10, 0, 0, 0, "Ch", "NO", 1, 0]

data2 =[[85403556, 9, 'Emergency', 'ToHome', 'EmergencyRoom', 9,
        217272690, 'Caucasian', 'Female', '[70-80)', 55, 1, 27, 0, 0, 0,
        'Ch', '>30', 2, 0],
       [5840622, 6, 'Urgent', 'ToHome', 'Referral', 4, 22206840,
        'AfricanAmerican', 'Male', '[40-50)', 66, 4, 27, 0, 0, 0, 'No',
        '>30', 1, 0]]
