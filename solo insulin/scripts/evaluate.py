...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr 12 21:49:18 2020
...
latest_model_accuracy = float(latest_model.tags.get("accuracy"))
print('Latest model accuracy: ', latest_model_accuracy)
print('Metric threshold criteria: ', args.metric_threshold)

deploy_model = False
if latest_model_accuracy < args.metric_threshold:
    deploy_model = True
...
eval_info["accuracy"] = latest_model_accuracy
